	...
	export default {
		...
		computed: {
			theMenus() {
				...
				if (typeof this.menus === "object") return [this.menus];
				return [];
			},
		},
	};
...
<template>
	<div class="PanelService-section">
		<div class="PanelService-section-body">
			<div class="PanelService-section-header" v-if="title || theMenus.length">
				<div class="PanelService-section-title">{{ title }}</div>

				<div class="PanelService-section-menus" v-if="theMenus.length">
					<ButtonIcon
