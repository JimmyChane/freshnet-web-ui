<script>
	...
	export default {
		key: "customer",
		title: "Customers",
		icon: { light: "customer-FFFFFF", dark: "customer-2A4858" },
...
<template>
	<div class="PageCustomer">
		...
		>
			...
			>
				<PanelCustomer
					class="PageCustomer-PanelCustomer"
					:item="drawerCustomer"
					...
					@click-item-device-update-description="
						(param) =>
							windowAction('windowUpdateDeviceDescription', 'start', param)
					"
				/>
			</Drawer>
		</div>
