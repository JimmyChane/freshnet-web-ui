...
<template>
   <Item class="ItemDevice" :selected="selected" :isSelectable="false">
      <div class="ItemDevice-body" v-if="item">
                  ...
                  :menus="[
                     {
                        ...
                        interact: () =>
                           $emit('click-update-description', { item }),
                     },
                     {
                        key: 'updateSpecification',
                        title: 'Update Specifications',
                        interact: () =>
                           $emit('click-update-specifications', { item }),
                     },
                     {
                        key: 'delete',
                        title: 'Delete',
         ...
         >
            ...
            <div
               class="ItemDevice-specification"
