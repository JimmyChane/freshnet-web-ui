<script>
   export default {
      ...
      computed: {
         itemTitle: (c) => (c.item ? c.item.title : ""),
         itemThumbnail: (c) => (c.item ? c.item.toImageThumbnail() : null),
         itemThumbnailUrl: (c) =>
            c.itemThumbnail ? c.itemThumbnail.toUrl({ width: 100 }) : "",
      },
   };
</script>

<template>
   <div class="ItemProductSuggest2 transition">
