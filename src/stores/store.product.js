...
export default {
   init(Stores) {
      ...
      context.actions.updateTitleOfId = async (
         context,
         arg = { id, title },
      ) => {
      ...
      context.actions.updateBrandIdOfId = async (
         context,
         arg = { id, brandId },
      ) => {
         return context.state.processor.acquire(
      ...
      context.actions.updateCategoryIdOfId = async (
         context,
         arg = { id, categoryId },
      ) => {
         return context.state.processor.acquire(
      ...
      context.actions.updateSecondHandOfId = async (
         context,
         arg = { id, isSecondHand },
      ) => {
         return context.state.processor.acquire(
      ...
      context.actions.updatePriceOfId = async (
         context,
         arg = { id, price },
      ) => {
      ...
      context.actions.removeBundleOfId = async (
         context,
         arg = { id, bundle },
      ) => {
         return context.state.processor.acquire(
      ...
      context.actions.updateSpecificationsOfId = async (
         ...
         return context.state.processor.acquire(
            ...
            async () => {
               ...
               const api = await requestUpdateSpecifications(
                  id,
                  specifications,
               );
               const error = api.getError();
      ...
      context.actions.addImageOfId = async (
         context,
         arg = { id, imageFile },
      ) => {
      ...
      context.actions.removeImageOfId = async (
         context,
         arg = { id, image },
      ) => {
