...
const init = (Stores) => {
    ...
    context.actions.getDeviceById = (context, id) => deviceStore.dispatch("getItemOfId", id);
    context.actions.getDevicesByIds = (context, ids) => deviceStore.dispatch("getItemsOfIds", ids);
    context.actions.addDevice = (context, arg) => deviceStore.dispatch("addItem", arg);
    context.actions.removeDevice = (context, arg) => deviceStore.dispatch("removeItemOfId", arg);
    context.actions.updateDeviceSpecifications = (context, arg) => deviceStore.dispatch("updateSpecificationsOfId", arg);
    context.actions.updateDeviceDescription = (context, arg) => deviceStore.dispatch("updateDescriptionOfId", arg);
