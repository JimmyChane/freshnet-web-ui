export const HOST_API = 'https://api.freshnet.app';
export const HOST_RES = 'https://res.freshnet.app';
export const CLOUDINARY_RES =
  'https://res.cloudinary.com/freshnet/image/upload/resource';

export const COMPANY_CATEGORY = 'Computer Store';
export const COMPANY_NAME = 'Freshnet Enterprise';
export const COMPANY_ADDRESS_LINK =
