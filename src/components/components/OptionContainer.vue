...
<template>
   <div
      ...
      :class="[isShowing ? 'OptionContainer-shown' : '']"
   >
      <button
         class="OptionContainer-main transition"
      ...
      <div
         class="OptionContainer-dropdown transition"
         :style="{ display: dropdownDisplay }"
      >
         <button
            class="OptionContainer-dropdown-body transition"
            v-for="menu in menus"
            :key="menu.key"
            @click="
               menu.interact();
