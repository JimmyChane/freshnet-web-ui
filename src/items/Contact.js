...
class ContactCategory {
    ...
    static Whatsapp = new ContactCategory("whatsapp", "Whatsapp", Host.icon("whatsapp-color"));
    static Telegram = new ContactCategory("telegram", "Telegram", Host.icon("telegram-color"));
    static Telephone = new ContactCategory("telephone", "Telephone", Host.icon("telephone-color"));
    key = "";
    title = "";
    icon = "";
...
class ContactLink {
    ...
    toHtmlHref() {
        if (this.category === ContactCategory.Call ||
