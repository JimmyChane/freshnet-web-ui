...
class CategoryBackground extends Image {
    static TABLET = new Image().fromData({
        method: "link",
        path: HostApi.res("background/daniel-romero--cCxgKIA5RA-unsplash-w300h100.webp"),
    });
    static NOTEBOOK = new Image().fromData({
        method: "link",
        path: HostApi.res("background/andras-vas-Bd7gNnWJBkU-unsplash-w300h100.webp"),
    });
    static DESKTOP = new Image().fromData({
        method: "link",
        path: HostApi.res("background/niclas-illg-wzVQp_NRIHg-unsplash-w300h100.webp"),
    });
    static PRINTER = new Image().fromData({
        method: "link",
        path: HostApi.res("background/mahrous-houses-5AoOejjRUrA-unsplash-w300h100.webp"),
    });
    ...
    static MOUSE = new Image().fromData({
        method: "link",
        path: HostApi.res("background/ryan-putra-j4PqlNVZ4Bc-unsplash-w300h100.webp"),
    });
    static KEYBOARD = new Image().fromData({
        method: "link",
        path: HostApi.res("background/girl-with-red-hat-Z6SXt1v5tP8-unsplash-w300h100.webp"),
    });
    static AUDIO = new Image().fromData({
        method: "link",
        path: HostApi.res("background/josh-sorenson-u8-QI4tRES0-unsplash-w300h100.webp"),
    });
    ...
    static WEBCAM = new Image().fromData({
        method: "link",
        path: HostApi.res("background/emiliano-cicero-lq87UxGSiEQ-unsplash-w300h100.webp"),
    });
    static CCTV = new Image().fromData({
        method: "link",
        path: HostApi.res("background/michal-jakubowski-oQD9uq4Rd4I-unsplash-w300h100.webp"),
    });
    static STORAGE = new Image().fromData({
        method: "link",
        path: HostApi.res("background/denny-muller-1qL31aacAPA-unsplash-w300h100.webp"),
    });
    static RAM = new Image().fromData({
        method: "link",
        path: HostApi.res("background/harrison-broadbent-ING1Uf1Fc30-unsplash-w300h100.webp"),
    });
    static NETWORK = new Image().fromData({
        method: "link",
        path: HostApi.res("background/jordan-harrison-40XgDxBfYXM-unsplash-w300h100.webp"),
    });
    static OTHER = new Image().fromData({
        method: "link",
        path: HostApi.res("background/christopher-bill-3l19r5EOZaw-unsplash-w300h100.webp"),
    });
    static getBackground(key) {
        switch (key) {
    ...
    toCount(strs) {
        return strs.reduce((count, str) => {
            ...
            if (ItemSearcher.textContains(this.title, str))
                count++;
            if (ItemSearcher.textContains("category", str))
                count++;
            return count;
        }, 0);
    }
